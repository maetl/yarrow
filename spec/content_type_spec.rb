...
describe Yarrow::Content::ContentType do
  it "assigns defaults when minimal data provided" do
    content_type = Yarrow::Content::ContentType.from_name(:posts)
  ...
  it "can be configured with a collection name" do
    properties = Yarrow::Content::ContentType::Value.new(collection: :posts)
    content_type = Yarrow::Content::ContentType.new(properties)
    expect(content_type.collection).to eq(:posts)
    expect(content_type.entity).to eq(:post)
  end

  it "can be configured with an entity name" do
    properties = Yarrow::Content::ContentType::Value.new(entity: :post)
    content_type = Yarrow::Content::ContentType.new(properties)
    expect(content_type.collection).to eq(:posts)
    expect(content_type.entity).to eq(:post)
  end
  ...
  it "can be configured with collection and entity names" do
    properties = Yarrow::Content::ContentType::Value.new(collection: :blog, entity: :post)
    content_type = Yarrow::Content::ContentType.new(properties)
  ...
  it "can be configured with a list of custom extensions" do
    properties = Yarrow::Content::ContentType::Value.new(collection: :pages, extensions: [".md", ".txt"])
    content_type = Yarrow::Content::ContentType.new(properties)
